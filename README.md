...
Service	URL	Port
User Service	http://localhost:3000/users	3000
Product Service	http://localhost:3001/products	3001
Order Service	http://localhost:3002/orders	3002
Gateway Service	http://localhost:3003/api/users	3003
